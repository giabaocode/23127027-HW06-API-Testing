...
| Defect ID | GitHub Issue | Severity | Category | Requirement Trace | Summary | Failing Test Cases | Detailed Report |
| :---: | :---: | :---: | :--- | :---: | :--- | :--- | :---: |
| **`DEF-FR07-01`** | *(Pending Issue Creation)* | **High** | Business Logic | `FR-07` (`README.md` L96) | Duplicate product addition appends separate row instead of accumulating quantity | `FR07-AI-009`, `010`, `011`, `FR07-STU-004` | [`DEF-FR07-01.md`](file:///Users/phamngocgiabao/eshop-sut/hw06/bugs/DEF-FR07-01.md) |
| **`DEF-FR07-02`** | *(Pending Issue Creation)* | **High** | Input Validation | `FR-07` (`README.md` L86) | `POST /api/cart` accepts invalid, negative, zero, and fractional quantities with HTTP 200 | `FR07-AI-014`..`018`, `020`, `021`, `023`, `024` | [`DEF-FR07-02.md`](file:///Users/phamngocgiabao/eshop-sut/hw06/bugs/DEF-FR07-02.md) |
