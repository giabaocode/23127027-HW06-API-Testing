# FR-12: Access Control — AI-Generated Test Suite (Original / Immutable)
...
- **Security Invariant Assertion:** SEC-03: Order status mutation requires role === 'admin'.
...
- **Security Invariant Assertion:** SEC-03: Catalog import strictly enforces role === 'admin'.
...
- **Security Invariant Assertion:** SEC-03: Coupon creation strictly requires role === 'admin'.
...
- **Security Invariant Assertion:** SEC-03: Coupon deletion requires role === 'admin'.
...
- **Security Invariant Assertion:** SEC-03: Catalog data-affecting APIs require role === 'admin' (README Line 177).
...
- **Security Invariant Assertion:** FR-12 / SEC-03: Admin clearance allows execution of user deletion handler.
...
- **Security Invariant Assertion:** SEC-02: Protected catalog mutation APIs require valid JWT token (README Line 177).
...
- **JWT Token State:** Expired JWT (exp claim in the past)
- **Embedded Role Claim:** `admin`
...
### Expected Access-Control Result
- **Semantic Authorization Outcome:** ACCESS DENIED (SEC-02 Violation: Expired token fails cryptographic verification)
...
- **Unauthorized Side-Effect Assertion:** Zero state modification.
- **Security Invariant Assertion:** SEC-02: Expired tokens must be invalidated by jwt.verify.
